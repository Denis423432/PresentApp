...
public class ElevSign extends AppCompatActivity {
    ...
    private final String FILENAMESIGN = "ElevSign.txt";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_elev_sign);
        ...
        sign.setOnClickListener(v -> {
            ...
            if (userPassword.isEmpty() && userId.isEmpty()) {
                ...
                if(file.exists()){
                    ...
                    String searchText = userId + " " + userPassword; // Textul pe care dorești să-l cauți
                    ...
                    try (FileInputStream fileInputStream = openFileInput(FILENAME);
                        ...
                        while ((line = bufferedReader.readLine()) != null) {
                            if (line.contains(searchText)) {
                                textExists = true;
                                break; // Ieși din buclă când găsești textul căutat
                            }
                        }
                    } catch (IOException e) {
                    ...
                    try (FileInputStream fileInputStream = openFileInput(FILENAME);
                        ...
                        while ((line2 = bufferedReader.readLine()) != null) {
                            ...
                            if (cleanLine.contains(searchUserId)) {
                                UserIdExists = true;
                                break;
                            }
                        }
                    ...
                    if (textExists) {
                        ...
                        if (fileSign.exists()) {
                            try (FileOutputStream fileOutputStream = openFileOutput(FILENAMESIGN, MODE_APPEND);
                                ...
                                File accountConfig = new File(getFilesDir(), userId + ".txt");
                                if (accountConfig.exists()) {
                                    Intent intent = new Intent(ElevSign.this, ElevAccount.class);
                                    startActivity(intent);
                                    Toast.makeText(ElevSign.this, "V-ati conectat la " + userId+ " configurat !", Toast.LENGTH_SHORT).show();
                                    Log.w(TAG, String.valueOf(accountConfig));
                                }
                                else {
                                    Intent intent = new Intent(ElevSign.this, ElevAccountConfig.class);
                                    startActivity(intent);
                                    Toast.makeText(ElevSign.this, "V-ati conectat la " + userId+ " neconfigurat !", Toast.LENGTH_SHORT).show();
                                    Log.w(TAG, String.valueOf(accountConfig));
                                }
                    ...
                    if (!textExists){
                        passwordError.setText("Ati gresit date la cont");
                    }
        ...
        ElevLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ElevSign.this, ElevLogin.class);
                startActivity(intent);
            }
        });
    }
